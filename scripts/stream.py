...
def ffmpeg_cmd(display: int, width: int, height: int,
    ...
    # Falls back to silent if pipe not ready
...
if __name__ == "__main__":
    ...
    if token_json:
        ...
        # Shorts: always created when token is available (same channel, separate stream)
        ...
        # Manual mode: no shorts (requires YOUTUBE_TOKEN_JSON for dual stream)
